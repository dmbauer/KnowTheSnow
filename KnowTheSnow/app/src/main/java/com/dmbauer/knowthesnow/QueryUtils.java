...
public final class QueryUtils {
     ...
     */
    public static List<Weather> fetchEarthquakeData(String requestUrl) {
        // Create URL object
     ...
     */
    private static List<Weather> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            JSONObject earthquakeObject = baseJsonResponse.getJSONObject("data");

            // Extract the JSONArray associated with the key called "features",
            // which represents a list of features (or weathers).
            JSONArray earthquakeArray = earthquakeObject.getJSONArray("text");

            // For each earthquake in the earthquakeArray, create an {@link Weather} object
            for (int i = 0; i < earthquakeArray.length(); i++) {

                // Extract the value for the key called "place"
                String location = earthquakeArray.getString(i);
